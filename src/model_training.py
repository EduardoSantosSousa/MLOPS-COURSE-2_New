...
class ModelTraining:
    ...
    def __init__(self, data_path):
        ...
        self.experiment = comet_ml.Experiment(
            api_key = "wkdDm8AZ0cH5eRupprroQQbTj",
            project_name = "ml-ops-course-2",
            workspace= "eduardosantossousa"
        )
    ...
    def load_data(self):
        ...
        try:
            ...
            return x_train_array, x_test_array, y_test, y_train
    ...
    def train_model(self):
        try:
            x_train_array, x_test_array, y_test, y_train = self.load_data() 
